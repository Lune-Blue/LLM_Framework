...
model_path_to_be_saved="checkpoints/${model_last_name}/${dataset_name}-hingeloss-${dataset_format}"
export WANDB_NAME=$(basename $model_path_to_be_saved)
accelerate launch \
    --config_file qlora/classification/accelerate_config_split.yaml qlora/classification/qlora_classification_hingeloss.py \
