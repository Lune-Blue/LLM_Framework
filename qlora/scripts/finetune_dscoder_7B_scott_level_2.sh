...
model_path_to_be_saved="checkpoints/scott_level_2/${model_last_name}/${dataset_name}-${dataset_format}-scott-level-2"
export WANDB_NAME=$(basename $model_path_to_be_saved)
accelerate launch \
    --config_file qlora/accelerate_config.yaml qlora/qlora.py \
    --model_name_or_path $base_model_name \
    --checkpoint_dir /home/lune/nas2/Projects/code_editing/checkpoints/deepseek-coder-6.7b-instruct/SCOTT-COFFEE-Editor-input_output_codegen-only/checkpoint-5400 \
    --use_auth \
